...
def main(args, train):
    ...
    for epoch in range(start_epoch, start_epoch + args.num_epochs):
        #train(epoch, net, trainloader, device, optimizer, scheduler, loss_fn, args.max_grad_norm, arg)
...
def default_args(train): 
    ...
    parser.add_argument('--hloss', default=False,  type=bool, help='Use hacky loss. ')
    parser.add_argument('--fastnll', default=False,  type=bool, help='Use fast NLL loss. ')
