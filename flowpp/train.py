...
def default_args(train): 
    ...
    parser.add_argument('--num_blocks', default=4, type=int, help='Number of blocks in Flow++')
    parser.add_argument('--num_components', default=8, type=int, help='Number of components in the mixture')
    parser.add_argument('--num_dequant_blocks', default=2, type=int, help='Number of blocks in dequantization')
    parser.add_argument('--num_channels', default=64, type=int, help='Number of channels in Flow++')
    ...
    parser.add_argument('--wloss', default=False, type=bool, help='Use wasserstein loss')
    parser.add_argument('--nloss', default=False,  type=bool, help='Use NLL loss. ')
